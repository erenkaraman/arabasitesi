    ...
    <form id="form1" runat="server">
     <div>
            <div style="width:100vw;height:100vh;background-color:#F9F9F9;">
                <div style="position:absolute;top:50%;margin-top:-225px;left:50%;margin-left:-175px;width:350px;height:450px;background-color:#fff;padding:25px;border-radius:5px;-webkit-box-shadow: 0px 0px 10px 0px rgba(0,0,0,1);-moz-box-shadow: 0px 0px 10px 0px rgba(0,0,0,1);box-shadow: 0px 0px 10px 0px rgba(0,0,0,1);">
                    ...
                    <div style="width:100%;margin-top:40px;margin-bottom:40px;">
                        ...
                        <input id="btngiris" onserverclick="btngiris_Click" runat="server" style="width:100%;margin-top:15px;text-transform:none" class="btn btn-success" type="button" value="Giriş Yap" />
                        <a href="sifremiunuttum.aspx">Şifremi Unuttum</a>
                    </div>
                    <a href="kayit.aspx"><div style="width:100%;margin-top:15px;text-transform:none" class="btn btn-primary">Veya Kayıt Ol</div></a>
                </div>
            </div>
        </div>
    </form>
